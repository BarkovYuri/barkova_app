    ...
    if len(parts) == 1:
        send_message(
            ...
            (
                ...
                "🔘  Нажмите кнопку <b>«Записаться»</b> снизу слева — "
                "откроется удобная форма записи.\n\n"
                "✏️  Введите <b>/</b> в поле сообщения — увидите меню "
                "со всеми командами:\n"
                "   /book — записаться\n"
...
def handle_help(chat_id: int) -> None:
    ...
    send_message(
        ...
        (
            ...
            "📅  <b>/book</b> — записаться на онлайн-разбор\n"
                    ...
                    # Handle regular messages (check for cancel request)
                        ...
                        if appointment:
                            ...
                            send_message(
                                ...
                                "<i>Чтобы записаться на онлайн-разбор — "
