...
HOW_IT_WORKS = [
    ...
    },
    {
        ...
        "description": (
            "Оставьте имя и телефон, опишите вопрос. Подключите VK для "
            "уведомлений."
        ),
        "order": 1,
    },
...
FAQ = [
    ...
    },
    {
        ...
        "answer": (
            ...
            "врач уточнит в VK после подтверждения записи."
        ),
        "order": 1,
    },
    {
    ...
    },
    {
        ...
        "answer": (
            ...
            "Сообщения в VK не пересылаются третьим лицам. "
