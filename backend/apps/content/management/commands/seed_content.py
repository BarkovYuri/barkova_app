...
HOW_IT_WORKS = [
    ...
    },
    {
        ...
        "title": "Подтверждение",
        "description": (
            "В мессенджер придёт сообщение с подтверждением и ссылкой "
...
FAQ = [
    ...
    },
    {
        ...
        "answer": (
            "За 10–15 минут до приёма в Telegram или VK придёт ссылка "
            "на видеовстречу. Вам нужны ноутбук или телефон с камерой "
            "и стабильный интернет. Никаких отдельных приложений ставить "
            "не нужно."
        ),
        "order": 1,
    },
